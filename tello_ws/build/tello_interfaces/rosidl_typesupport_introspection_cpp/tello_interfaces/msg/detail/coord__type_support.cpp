...
{
  new (message_memory) tello_interfaces::msg::Coord(_init);
}

void Coord_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tello_interfaces::msg::Coord *>(message_memory);
  typed_message->~Coord();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Coord_message_member_array[2] = {
  {
    "coordx",  // name
    ...
    offsetof(tello_interfaces::msg::Coord, coordx),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tello_interfaces::msg::Coord, coordy),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Coord_message_members = {
  "tello_interfaces::msg",  // message namespace
  "Coord",  // message name
  2,  // number of fields
  sizeof(tello_interfaces::msg::Coord),
...
{
  return &::tello_interfaces::msg::rosidl_typesupport_introspection_cpp::Coord_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tello_interfaces, msg, Coord)() {
  return &::tello_interfaces::msg::rosidl_typesupport_introspection_cpp::Coord_message_type_support_handle;
}
