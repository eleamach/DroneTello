...
static const _DroneMode_Request_type_support_symbol_names_t _DroneMode_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tello_interfaces, srv, DroneMode_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tello_interfaces, srv, DroneMode_Request)),
  }
};
...
{
  return &::tello_interfaces::srv::rosidl_typesupport_cpp::DroneMode_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tello_interfaces, srv, DroneMode_Request)() {
  return get_message_type_support_handle<tello_interfaces::srv::DroneMode_Request>();
}
...
static const _DroneMode_Response_type_support_symbol_names_t _DroneMode_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tello_interfaces, srv, DroneMode_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tello_interfaces, srv, DroneMode_Response)),
  }
};
...
{
  return &::tello_interfaces::srv::rosidl_typesupport_cpp::DroneMode_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tello_interfaces, srv, DroneMode_Response)() {
  return get_message_type_support_handle<tello_interfaces::srv::DroneMode_Response>();
}
...
static const _DroneMode_type_support_symbol_names_t _DroneMode_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tello_interfaces, srv, DroneMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tello_interfaces, srv, DroneMode)),
  }
};
...
{
  return &::tello_interfaces::srv::rosidl_typesupport_cpp::DroneMode_service_type_support_handle;
}
